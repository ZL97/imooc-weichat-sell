package com.example.weichatsell.aspect;
...
public class SellerAuthorize {
    ...
    @Pointcut("execution(public * com.example.weichatsell.controller.Seller*.*(..))" +
            "&&!execution(public * com.example.weichatsell.controller.SellerUserController.*(..))")
    public void verify() {
    }
